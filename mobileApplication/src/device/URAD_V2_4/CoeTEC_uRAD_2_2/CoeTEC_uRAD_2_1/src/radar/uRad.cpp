...
String uRad::GetRadarObjects()
{
    ...
    // // Serial.print("Magic word sent to Bluetooth: ");
    ...
    for (int i = 0; i < m_objs; i++)
    {
        ...
        // //   //   //send velocity
        // //   //   buffer1.puch_back((uint8_t)data[i].obj_v);
        // //   //   Serial.print("Velocity  sent: ");
        // //   //   Serial.println((uint8_t)data[i].obj_v, HEX);
    ...
    // // //send the array to bluetooth
    // // pCharacteristic->setValue(buffer2, buffer1.size());
    // // //notify the client
