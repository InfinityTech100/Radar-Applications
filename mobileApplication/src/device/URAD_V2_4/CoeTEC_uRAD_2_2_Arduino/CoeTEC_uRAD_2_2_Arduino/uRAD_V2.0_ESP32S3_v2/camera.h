...
private:
  ...
  uint16_t vga_w = 0x8002;
  uint16_t vga_h = 0xE001;
  uint16_t cif_w = 0x9001;
  uint16_t cif_h = 0x2801;
  uint16_t svga_w = 0x2003;
  uint16_t svga_h = 0x5802;
  uint16_t uxga_w = 0x4006;
  uint16_t uxga_h = 0xB004; 
  ...
  void make_avi();
  void major_fail();
  void print_quartet(unsigned long i, fs::File fd);
  void changeSetting(CameraSetting newSetting);
  void start_avi();
  void end_avi();
  void do_fb();
  void another_pic_avi();
